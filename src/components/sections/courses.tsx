    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            Learn from Industry Experts. Build Real Projects. Launch Your Career.
          </h2>
          ...
          >
            Gain hands-on experience through live projects, expert mentorship, and industry-standard tools. Build a portfolio that helps you secure internships, freelance clients, or a full-time career.
          </p>
        </div>
