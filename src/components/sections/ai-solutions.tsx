        ...
        <div className="mt-16 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
          {aiSolutions.map((sol, i) => (
            <motion.article
              ...
              className="group relative overflow-hidden rounded-3xl border border-white/[0.08] bg-gradient-to-br from-[#0d1030]/80 via-[#0a0c24]/60 to-[#0a0c24]/40 p-6 backdrop-blur-xl transition-all duration-500 hover:-translate-y-1 hover:border-[#00e0c6]/40 interactive sm:p-7"
            >
