            ...
            <div className="mt-6 flex gap-2">
              {SOCIALS.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="interactive flex h-9 w-9 items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] text-muted-foreground transition-all duration-300 hover:border-[#7c5cff]/50 hover:bg-[#7c5cff]/10 hover:text-[#00e0c6]"
                >
