...
export function Hero() {
  ...
  return (
    <section
      id="hero"
      className="hero-bg relative flex flex-col items-center justify-center overflow-hidden bg-[#050614] px-4 pt-28 pb-[60px] sm:px-6"
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-1/3 z-[3] h-[480px] w-[900px] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-80 blur-[120px] hero-aurora"
        style={{
          background:
            "radial-gradient(ellipse at center, rgba(124,92,255,0.55) 0%, rgba(0,224,198,0.35) 45%, rgba(255,77,210,0.2) 70%, transparent 85%)",
        }}
      />
      ...
      <div className="relative z-50 mx-auto flex max-w-5xl flex-col items-center text-center">
        ...
        >
          ...
          <span className="text-gradient-cyan inline-block font-extrabold">Software</span>
          <br />
          <span className="text-white">Development Company for</span>
          <br />
          {/* Typewriter rotating word */}
          <span className="relative inline-block text-left">
            <span className="inline-block text-gradient-magenta font-extrabold">{displayedText}</span>
            <span className="typewriter-cursor text-gradient-magenta" aria-hidden="true" />
          </span>
        </motion.h1>
