      ...
      >
        ...
        >
          ...
          <a href="/" className="group flex items-center gap-2.5 interactive">
            <div className="relative h-9 w-9 overflow-hidden rounded-xl p-[1.5px] shadow-[0_0_24px_rgba(124,92,255,0.5)]" style={{ background: 'linear-gradient(to bottom right, #7c5cff, #00e0c6)' }}>
          ...
          <div className="hidden items-center gap-1 lg:flex">
            {NAV_LINKS.map((l) => (
              ...
              >
                {l.label}
                <span className="absolute inset-x-4 bottom-1 h-px scale-x-0 transition-transform duration-300 hover:scale-x-100" style={{ background: 'linear-gradient(to right, #7c5cff, #00e0c6)' }} />
              </a>
            ))}
          </div>
          ...
          <>
            ...
            >
                ...
                >
                  {NAV_LINKS.map((l, i) => (
                    ...
                    >
                      ...
                      <span className="absolute inset-0 rounded-2xl opacity-0 transition-all duration-500 group-hover:opacity-100" style={{ background: 'linear-gradient(to right, rgba(124,92,255,0), rgba(124,92,255,0), rgba(0,224,198,0))' }} />

                      {/* Animated underline sweep */}
                      <span className="absolute bottom-0 left-5 right-5 h-px origin-left scale-x-0 transition-transform duration-500 ease-[0.22,1,0.36,1] group-hover:scale-x-100" style={{ background: 'linear-gradient(to right, rgba(124,92,255,0.6), rgba(0,224,198,0.4), transparent)' }} />
              ...
              <motion.div
                ...
                aria-hidden
                className="mx-6 h-px"
                style={{ background: 'linear-gradient(to right, transparent, rgba(124,92,255,0.3), transparent)' }}
              />
              ...
              <div className="relative px-6 py-6 sm:px-7">
                <motion.a
                  ...
                  className="interactive relative flex items-center justify-center gap-2.5 overflow-hidden rounded-2xl px-6 py-4 text-[15px] font-bold text-white shadow-[0_0_40px_rgba(124,92,255,0.35)] transition-shadow duration-500 hover:shadow-[0_0_60px_rgba(124,92,255,0.55)]"
                  style={{ background: 'linear-gradient(to right, #7c5cff, #00e0c6)' }}
                >
                  {/* Multi-layer shimmer */}
                  <span className="pointer-events-none absolute inset-0 -translate-x-full animate-[shimmer_2s_linear_infinite]" style={{ background: 'linear-gradient(to right, transparent, rgba(255,255,255,0.25), transparent)' }} />
                  <span className="pointer-events-none absolute inset-0 translate-x-full animate-[shimmer_2.5s_linear_infinite]" style={{ background: 'linear-gradient(to right, transparent, rgba(255,255,255,0.1), transparent)' }} />
                ...
                >
                  <span className="h-px w-6" style={{ background: 'linear-gradient(to right, transparent, rgba(255,255,255,0.15))' }} />
                  Building the future, one pixel at a time
                  <span className="h-px w-6" style={{ background: 'linear-gradient(to left, transparent, rgba(255,255,255,0.15))' }} />
                </motion.p>
              </div>
