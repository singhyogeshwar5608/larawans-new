              ...
              <div className="bg-white rounded-2xl border border-slate-100 shadow-[0_4px_24px_rgba(0,0,0,0.1)] p-8 sm:p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                  {course.topics.map((tp: string, i: number) => (
                    <div key={i} className="flex items-center gap-3.5 bg-emerald-50/40 hover:bg-emerald-50/70 border border-emerald-100/50 hover:border-emerald-200/70 rounded-lg px-5 py-3.5 transition-all duration-200">
