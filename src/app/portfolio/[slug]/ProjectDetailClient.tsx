    ...
    <div className="min-h-screen bg-[#050614] text-foreground antialiased selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      <main className="relative pt-16 pb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-4">
              {project.impactMetrics.map((m, idx) => (
                <div
                  key={idx}
                  className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.02] p-5 backdrop-blur group hover:border-cyan-500/40 transition-all duration-300"
                >
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="space-y-4">
                {project.workflowSteps.map((wf) => (
                  ...
                  >
                    <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-gradient-to-tr from-violet-600 to-cyan-500 text-xs font-bold text-white shadow-md">
                      {wf.step}
                    </span>
                    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {project.keyFeatures.map((feat, i) => {
              ...
              return (
                <div
                  key={i}
                  className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/[0.05] to-white/[0.02] p-6 backdrop-blur hover:border-cyan-500/50 hover:bg-white/[0.08] transition-all duration-300"
                >
        ...
        <section className="mx-auto max-w-7xl px-4 sm:px-6 pt-8">
          <div className="relative overflow-hidden rounded-3xl border border-cyan-500/30 bg-gradient-to-r from-violet-950/80 via-[#0b0f24] to-cyan-950/80 p-8 sm:p-12 text-center backdrop-blur">
